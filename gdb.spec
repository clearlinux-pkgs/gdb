...
Source0  : https://mirrors.kernel.org/gnu/gdb/gdb-15.2.tar.xz
Source1  : https://mirrors.kernel.org/gnu/gdb/gdb-15.2.tar.xz.sig
...
%setup -q -n gdb-15.2
cd %{_builddir}/gdb-15.2
pushd ..
cp -a gdb-15.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730511560
unset LD_AS_NEEDED
