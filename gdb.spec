...
Source0  : https://mirrors.kernel.org/gnu/gdb/gdb-14.1.tar.xz
Source1  : https://mirrors.kernel.org/gnu/gdb/gdb-14.1.tar.xz.sig
...
%prep
%setup -q -n gdb-14.1
cd %{_builddir}/gdb-14.1
pushd ..
cp -a gdb-14.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702286272
unset LD_AS_NEEDED
