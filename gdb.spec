...
Source0  : https://mirrors.kernel.org/gnu/gdb/gdb-16.3.tar.gz
Source1  : https://mirrors.kernel.org/gnu/gdb/gdb-16.3.tar.gz.sig
...
%setup -q -n gdb-16.3
cd %{_builddir}/gdb-16.3
pushd ..
cp -a gdb-16.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745245049
unset LD_AS_NEEDED
